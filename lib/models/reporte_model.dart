class Reporte {
  ...
  List<Perforacion> perforaciones; // Lista para almacenar los datos de perforación
  ...
  Reporte({
    ...
    this.perforaciones = const [], // Inicializamos la lista de perforaciones como una lista vacía por defecto
  });
...
class Perforacion {
  ...
  factory Perforacion.fromMap(Map<String, dynamic> map) {
    return Perforacion(
      id: map['id'],
      tipo: map['tipo'],
      tamano: map['tamano'],
